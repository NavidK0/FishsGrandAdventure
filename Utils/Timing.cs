...
namespace MEC
{
    ...
    public class Timing : MonoBehaviour
    {
                ...
                for (coindex.i = 0; coindex.i < _lastSlowUpdateProcessSlot; coindex.i++)
                {
                    ...
                    try
                    {
                            ...
                            !(localTime < SlowUpdateProcesses[coindex.i].Current))
                        {
                            ...
                            name = _taggedProcesses
                                       .FirstOrDefault(x => x.Value.Any(handle => handle == currentCoroutine)).Key ??
                                   "Unknown";
        ...
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallPeriodically(float timeframe, float period, System.Action action,
            Segment segment, System.Action onDone = null)
        {
            return action == null
                ? new CoroutineHandle()
        ...
        private IEnumerator<float> _CallContinuously(float timeframe, float period, System.Action action,
...
public static class MECExtensionMethods2
{
    ...
    {
        while (MEC.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 &&
